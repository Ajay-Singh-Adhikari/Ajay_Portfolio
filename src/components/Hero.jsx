    ...
    >
      ...
      <div className="flex space-x-4 mt-6">
        <a
          ...
          className="text-pink-600 hover:text-white border border-pink-600 rounded-full p-3 transition"
        >
          <FaLinkedin size={20} />
        </a>
        <a
      ...
      <button className="mt-6 px-6 py-2 bg-pink-600 hover:bg-white hover:text-pink-600 rounded-full transition shadow-lg hover:shadow-pink-600/50">
        Hire Me
      </button>
    </section>
  );
